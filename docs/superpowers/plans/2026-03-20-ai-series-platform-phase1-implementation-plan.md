...
- `tests/e2e/phase1-acceptance.spec.ts`
- `tests/e2e/phase1-real-acceptance.spec.ts`
...
Run: `pnpm exec playwright test tests/e2e/phase1-real-acceptance.spec.ts`
Run: `go test ./...`
...
7. CI 门禁稳定执行 `buf lint`、`buf breaking`、`turbo run lint`、`turbo run test`、`turbo run build`、`go test ./...`、`i18n key parity check`、`test:e2e:phase1`、`test:e2e:phase1:real`。
