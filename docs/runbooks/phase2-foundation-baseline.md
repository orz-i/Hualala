...
- 首批协同 / 预演 shared truth 的 proto、SDK client、backend persistence 与 migration
...
- 首批协同 / 预演 shared truth 统一经由 `content.proto`、`project_service.proto`、对应 SDK client 与 `0015_phase2_collab_preview_shared_truth.sql` 收口
...
5. 需要通过 foundation micro-patch 新增首批协同 / 预演 shared truth，且范围限定在 `content.proto`、`project_service.proto`、对应 SDK client、backend persistence 与 migration
